...
// var ser = document.getElementById('pop-search');
...
// working on hiding when navbar is open
...
function qSlide(q_slide) {
  ...
  function q_slideSwitch(q_slide,index,auto){
    ...
    // caption animation
      ...
      var letters2 = newSlide.querySelectorAll('.q_splitText2');
        if (letters) {
        ...
        if (letters2) {
            for (var i = letters2.length - 1; i >= 0; i--) {
              var letter2 = letters2[i];
              q_animate(letter2, splitAnim, 100);
            };
